...
<head>
    ...
    <title>
        Laporan Data Rujukan Bayi Pertanggal
    </title>
    ...
    <section class="wrapper-invoice">
        ...
        <div class="invoice">
            <div class="invoice-information">
                <p><b>Laporan Data Rujukan Bayi Pertanggal </b></p>
            ...
            <div class="invoice-body">
                <table class="table">
                    ...
                    <tbody>
                        <?php $total = 0;
                        $no = 1;
                        foreach ($rujukan_bayi as $data) { ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><?= $data['tanggalRujukan'] ?></td>
                                <td><?= $data['bayiNoRM'] ?></td>
                                <td><?= $data['bayiNama'] ?></td>
                                <td><?= $data['kepada'] ?></td>
                                <td><?= $data['alamat'] ?></td>
