    ...
    <section class="wrapper-invoice">
        ...
        <div class="invoice">
            <div class="invoice-information">
                ...
                <p><?= $rujukan_ibu['ibuRM'] ?></p>
                <p><?= $rujukan_ibu['ibuNama'] ?></p>
            </div>
            <!-- logo brand invoice -->
            ...
            <div class="invoice-body">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>Nama Pasien</td>
                            <td><?= $rujukan_ibu['ibuNama'] ?></td>
                        </tr>
                        <tr>
                            <td>Tanggal Rujukan</td>
                            <td><?= $rujukan_ibu['tanggalRujukan'] ?></td>
                        </tr>
                        <tr>
                            <td>Tujuan Rujukan</td>
                            <td><?= $rujukan_ibu['kepada'] ?></td>
                        </tr>
                        <tr>
                            <td>Alamat</td>
                            <td><?= $rujukan_ibu['alamat'] ?></td>
                        </tr>
                        <tr>
                            <td>Hasil Pemeriksaan</td>
                            <td><?= $rujukan_ibu['hasilPemeriksaan'] ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
