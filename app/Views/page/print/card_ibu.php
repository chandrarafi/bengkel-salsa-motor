                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <span class="mb-2 fw-medium text-secondary-light text-md">Kartu Pasien Ibu</span>
                            <h6 class="fw-semibold text-secondary-light my-1"><?= $ibu['ibuRM'] ?></h6>
                            <h5 class="fw-semibold text-secondary-light my-1"><?= $ibu['ibuNama'] ?></h5>
                        </div>
                    </div>
                </div>
            </div>
