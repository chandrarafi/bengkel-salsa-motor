                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="icon-field">
                                ...
                                <input type="number" name="harga" id="harga" class="form-control form-control-sm radius-8 <?= isset($errors['harga']) ? 'is-invalid' : '' ?>" value="<?= old('harga', $barang['harga']) ?>" placeholder="Harga barang" min="0" required>
                            </div>
