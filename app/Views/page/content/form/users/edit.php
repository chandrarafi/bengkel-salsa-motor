...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-20">
    <h6 class="fw-semibold mb-0 text-lg">Edit Data User</h6>
...
<div class="col-lg-12">
    <div class="card radius-12 border">
        <div class="card-header border-bottom border-neutral-200 px-20 py-14 d-flex align-items-center justify-content-between">
            <h6 class="card-title mb-0 text-base fw-bold">Edit User: <?= esc($user['nama']) ?></h6>
            <span class="badge bg-neutral-200 text-secondary-light text-xs font-bold">ID: #<?= esc($user['id']) ?></span>
        </div>
        <div class="card-body p-20">
            <form action="<?= site_url('admin/users/update/' . esc($user['id'])) ?>" method="post" class="row g-3 needs-validation" novalidate>
                <?= csrf_field() ?>
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field">
                        ...
                        <input type="text" name="nama" class="form-control form-control-sm radius-8 <?= !empty($errors['nama']) ? 'is-invalid' : '' ?>" placeholder="Masukkan Nama Lengkap" value="<?= old('nama', $user['nama']) ?>" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field">
                        ...
                        <input type="email" name="email" class="form-control form-control-sm radius-8 <?= !empty($errors['email']) ? 'is-invalid' : '' ?>" placeholder="Masukkan Email" value="<?= old('email', $user['email']) ?>" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field">
                        ...
                        <?php $selectedLevel = old('level', $user['level']); ?>
                        <select name="level" class="form-select form-select-sm radius-8 <?= !empty($errors['level']) ? 'is-invalid' : '' ?>" required>
                            <option value="admin" <?= strtolower($selectedLevel) === 'admin' ? 'selected' : '' ?>>Administrator</option>
                            <option value="pimpinan" <?= strtolower($selectedLevel) === 'pimpinan' ? 'selected' : '' ?>>Pimpinan</option>
                            <option value="pelanggan" <?= strtolower($selectedLevel) === 'pelanggan' ? 'selected' : '' ?>>Pelanggan</option>
                        </select>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <label class="form-label text-xs fw-semibold text-neutral-700 mb-1">Kata Sandi <small class="text-secondary-light fw-normal">(Kosongkan jika tidak ingin diubah)</small></label>
                    <div class="icon-field">
                        <span class="icon">
                            <iconify-icon icon="solar:lock-password-outline"></iconify-icon>
                        </span>
                        <input type="password" name="password" class="form-control form-control-sm radius-8 <?= !empty($errors['password']) ? 'is-invalid' : '' ?>" placeholder="••••••••">
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field">
                        ...
                        <input type="text" name="no_hp" class="form-control form-control-sm radius-8" placeholder="Contoh: 081234567890" value="<?= old('no_hp', $user['no_hp']) ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field">
                        ...
                        <input type="text" name="alamat" class="form-control form-control-sm radius-8" placeholder="Alamat tinggal pengguna" value="<?= old('alamat', $user['alamat']) ?>">
                    </div>
                </div>
