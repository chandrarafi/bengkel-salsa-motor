...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    ...
    <ul class="d-flex align-items-center gap-2">
        <li class="fw-medium">
            <a href="<?= site_url('rujukan-bayis') ?>" class="d-flex align-items-center gap-1 hover-text-primary">
                <iconify-icon icon="solar:document-add-outline" class="icon text-lg"></iconify-icon>
                Pelayanan Rujukan Bayi
            </a>
        </li>
    </ul>
</div>
    ...
    <div id="table-bayi" class="card basic-data-table mb-20">
        <div class="card-header">
            <div class="row align-items-center justify-content-between">
                <div class="col-auto">
                    <h5 class="card-title mb-0">Pilih Bayi</h5>
                </div>
            </div>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    <?php foreach ($bayis as $bayi) : ?>
                        <tr>
                            ...
                            <td><?= esc($bayi['tanggalLahir']) ?></td>
                            <td><?= esc($bayi['jenisKelamin']) ?></td>
                            <td><?= esc($bayi['ibuNama']) ?></td>
                            <td>
...
<div class="col-lg-12 mb-10">
    <div id="table-tambah-bayi" class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Edit Data Rujukan Bayi</h5>
        </div>
        <div class="card-body">
            <form action="<?= site_url('update-rujukan-bayi') ?>" method="post" class="row gy-3 needs-validation" novalidate>
                ...
                <div class="col-md-6">
                    ...
                    <div class="has-validation">
                        ...
                        <input type="hidden" id="bayiID" name="bayiID" value="<?= esc($rujukanBayi['bayiID']) ?>">
                        <div class="input-group">
                            <input type="text" id="bayiNama" name="bayiNama" value="<?= esc($rujukanBayi['bayiNama']) ?>" class="form-control" placeholder="Pilih Data Bayi" readonly>
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="date" name="tanggalRujukan" class="form-control" placeholder="Masukkan Tanggal Rujukan" value="<?= esc($rujukanBayi['tanggalRujukan']) ?>" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="text" name="kepada" value="<?= esc($rujukanBayi['kepada']) ?>" class="form-control" placeholder="Tujuan Rujukan" required>
                        <div class="invalid-feedback">
                            Kepada dibutuhkan
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <textarea name="alamat" class="form-control" placeholder="Alamat Rujukan" required><?= esc($rujukanBayi['alamat']) ?></textarea>
                        <div class="invalid-feedback">
                            Alamat dibutuhkan
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="text" name="hasilPemeriksaan" value="<?= esc($rujukanBayi['hasilPemeriksaan']) ?>" class="form-control" placeholder="Masukkan Hasil Pemeriksaan" required>
                        <div class="invalid-feedback">
                ...
                <div class="d-flex align-items-center gap-3">
                    <a href="<?= site_url('rujukan-bayi') ?>" class="border border-danger-600 bg-hover-danger-200 text-danger-600 text-md px-56 py-11 radius-8 d-flex align-items-center gap-2">
