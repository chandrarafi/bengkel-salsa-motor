...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    ...
    <ul class="d-flex align-items-center gap-2">
        <li class="fw-medium">
            <a href="<?= site_url('penggunaan-kamars') ?>" class="d-flex align-items-center gap-1 hover-text-primary">
                <iconify-icon icon="solar:document-add-outline" class="icon text-lg"></iconify-icon>
                Pelayanan Penggunaan Kamar
            </a>
        </li>
    </ul>
</div>
...
<div class="col-lg-12 mb-10">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Tambah Penggunaan Kamar</h5>
        </div>
        <div class="card-body">
            <form action="<?= site_url('add-penggunaan-kamar') ?>" method="post" class="row gy-3 needs-validation" novalidate>
                <?= csrf_field() ?>
                <div class="col-md-6">
                ...
                <div class="col-md-3">
                    ...
                    <div class="has-validation">
                        <input type="hidden" id="kamarID" name="kamarID" required>
                        <div class="input-group">
                            <input type="text" id="kamarNama" name="kamarNama" class="form-control" placeholder="Pilih Data Kamar" readonly>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" id="biayaKamar" name="biayaKamar" class="form-control" placeholder="Pilih Kamar" readonly required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" id="tanggalMasuk" name="tanggalMasuk" class="form-control" placeholder="Masukkan Tanggal Masuk" required>
                    <div class="invalid-feedback">
                        Tanggal Masuk dibutuhkan
                    </div>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Estimasi Tanggal Keluar</label>
                    <input type="date" id="tanggalKeluar" name="tanggalKeluar" class="form-control" placeholder="Masukkan Tanggal Keluar" required>
                    <div class="invalid-feedback">
                ...
                <div class="d-flex align-items-center gap-3">
                    <a href="<?= site_url('penggunaan-kamar') ?>" class="border border-danger-600 bg-hover-danger-200 text-danger-600 text-md px-56 py-11 radius-8 d-flex align-items-center gap-2">
                        <iconify-icon icon="mingcute:back-fill" class="text-xl"></iconify-icon> Batal
                    </a>
                    <button id="saveButton" type="submit" class="btn btn-primary-600 text-md px-56 py-11 radius-8 d-flex align-items-center gap-2">
...
<script>
    function checkRoomAvailability() {
        const kamarID = $('#kamarID').val();
        const tanggalMasuk = $('#tanggalMasuk').val();
        const tanggalKeluar = $('#tanggalKeluar').val();

        if (kamarID && tanggalMasuk && tanggalKeluar) {
            $.ajax({
                url: '<?= site_url('check-availability') ?>',
                type: 'POST',
                data: {
                    kamarID: kamarID,
    ...
    $('#tanggalMasuk').change(checkRoomAvailability);
    $('#tanggalKeluar').change(checkRoomAvailability);
