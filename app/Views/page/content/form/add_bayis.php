...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <h6 class="fw-semibold mb-0">Pasien Bayi</h6>
...
<div class="col-lg-12 mb-10">
    <div id="tambah-table-bayi" class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Data Pasien Bayi</h5>
        </div>
        <div class="card-body">
            <form action="<?= site_url('add-bayis') ?>" method="post" class="row gy-3 needs-validation" novalidate>
                <?= csrf_field() ?>
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="text" name="bayiNama" class="form-control" placeholder="Masukan Nama Bayi" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="date" name="tanggalLahir" class="form-control" placeholder="Masukan Tanggal Lahir" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="time" name="jamLahir" class="form-control" placeholder="Masukan Jam Lahir" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="number" name="beratLahir" class="form-control" placeholder="Masukan Berat Lahir (gram)" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="number" name="tinggiLahir" class="form-control" placeholder="Masukan Tinggi Lahir (cm)" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        <span class="icon">
                            <iconify-icon icon="mdi:child-care"></iconify-icon>
                        </span>
                        <input type="number" name="anakKe" class="form-control" placeholder="Masukan Anak Ke" required>
                        <div class="invalid-feedback">
                            Anak Ke dibutuhkan
                        </div>
                    </div>
