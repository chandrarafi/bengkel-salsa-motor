...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-20">
    <h6 class="fw-semibold mb-0 text-lg">Edit Transaksi Barang Masuk</h6>
...
<form id="updateBarangMasukForm" action="<?= site_url('admin/barangmasuk/update/' . esc($header['faktur'])) ?>" method="post">
    <?= csrf_field() ?>
            ...
            <div class="card radius-12 border h-100">
                ...
                <div class="card-body p-20">
                    <div class="row g-3">
                        <!-- No Faktur (Readonly) -->
                        <div class="col-12">
                            <label class="form-label text-xs fw-semibold text-neutral-700 mb-1">No. Faktur</label>
                        ...
                        <div class="col-12">
                            ...
                            <input type="date" name="tanggalfaktur" id="tanggalfaktur" class="form-control form-control-sm radius-8" value="<?= esc($header['tanggalfaktur']) ?>" required>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="keterangan" id="keterangan" class="form-control form-control-sm radius-8" rows="5" style="min-height: 120px;" placeholder="Tuliskan catatan transaksi, nama toko supplier, alamat, atau nomor telepon supplier..."><?= esc($header['keterangan']) ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#updateBarangMasukForm').on('submit', function(e) {
            e.preventDefault();
            var form = this;
