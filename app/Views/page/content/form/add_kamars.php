...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    ...
    <ul class="d-flex align-items-center gap-2">
        <li class="fw-medium">
            <a href="<?= site_url('kamar') ?>" class="d-flex align-items-center gap-1 hover-text-primary">
...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?= site_url('add-kamars') ?>" method="post" class="row gy-3 needs-validation" novalidate>
                <?= csrf_field() ?>
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="text" name="kamarNama" class="form-control" placeholder="Masukkan Nama Kamar" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <select name="kamarTipe" class="form-control" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="number" name="kamarBiaya" class="form-control" placeholder="Masukkan Biaya Kamar" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="number" name="kapasitas" class="form-control" placeholder="Masukkan Kapasitas Kamar" required>
                        <div class="invalid-feedback">
                ...
                <div class="d-flex align-items-center gap-3">
                    <a href="<?= site_url('kamar') ?>" class="border border-danger-600 bg-hover-danger-200 text-danger-600 text-md px-56 py-11 radius-8 d-flex align-items-center gap-2">
