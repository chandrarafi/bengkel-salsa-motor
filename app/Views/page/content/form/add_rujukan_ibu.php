...
<div class="col-lg-12 mb-10">
    <div id="table-tambah-ibu" class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Tambah Data Rujukan Ibu</h5>
        </div>
        <div class="card-body">
            <form action="<?= site_url('add-rujukan-ibu') ?>" method="post" class="row gy-3 needs-validation" novalidate>
                <?= csrf_field() ?>
                <div class="col-md-6">
