...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Edit Data <?= esc($user['userID']) ?></h5>
        </div>
        <div class="card-body">
            <form action="<?= site_url('update-users') ?>" method="post" class="row gy-3 needs-validation" novalidate>
                <?= csrf_field() ?>
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="text" name="userNama" class="form-control" placeholder="Masukan Nama Lengkap" value="<?= esc($user['userNama']) ?>" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="email" name="userEmail" class="form-control" placeholder="Masukan Email" value="<?= esc($user['userEmail']) ?>" required>
                        <div class="invalid-feedback">
                            Email dibutuhkan
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <select class="form-control radius-8 form-select" name="userRole">
                            <option value="Administrator" <?= esc($user['userRole']) == 'Administrator' ? 'selected' : '' ?>>Administrator</option>
                            <option value="Bidan" <?= esc($user['userRole']) == 'Bidan' ? 'selected' : '' ?>>Bidan</option>
                            <option value="Owner" <?= esc($user['userRole']) == 'Owner' ? 'selected' : '' ?>>Owner</option>
                        </select>
                        <div class="invalid-feedback">
                            Role dibutuhkan
                        </div>
