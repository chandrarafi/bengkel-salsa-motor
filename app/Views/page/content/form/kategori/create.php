...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-20">
    <h6 class="fw-semibold mb-0 text-lg">Tambah Kategori Baru</h6>
...
<div class="col-lg-8">
    <div class="card radius-12 border">
        <div class="card-header border-bottom border-neutral-200 px-20 py-14">
            <h6 class="card-title mb-0 text-base fw-bold">Form Tambah Kategori</h6>
        </div>
        <div class="card-body p-20">
            <form action="<?= site_url('admin/kategori/store') ?>" method="post" class="row g-3 needs-validation" novalidate>
                <?= csrf_field() ?>
                ...
                <div class="col-12">
                    ...
                    <div class="icon-field">
                        ...
                        <input type="text" name="namakategori" class="form-control form-control-sm radius-8 <?= (isset($validation) && $validation->hasError('namakategori')) ? 'is-invalid' : '' ?>" placeholder="Contoh: Sparepart Mesin" value="<?= old('namakategori') ?>" required>
