...
<div class="col-lg-12 mb-10">
    <div id="table-tambah-bayi" class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Tambah Data Rujukan Bayi</h5>
        </div>
        <div class="card-body">
            <form action="<?= site_url('add-rujukan-bayi') ?>" method="post" class="row gy-3 needs-validation" novalidate>
                <?= csrf_field() ?>
                <div class="col-md-6">
                    <label class="form-label">Pilih Bayi</label>
                    <div class="has-validation">
                        <input type="hidden" id="bayiID" name="bayiID">
                        <div class="input-group">
                            <input type="text" id="bayiNama" name="bayiNama" class="form-control" placeholder="Pilih Data Bayi" readonly>
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="date" name="tanggalRujukan" class="form-control" placeholder="Masukkan Tanggal Rujukan" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="text" name="kepada" class="form-control" placeholder="Tujuan Rujukan" required>
                        <div class="invalid-feedback">
                            Kepada dibutuhkan
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <textarea name="alamat" class="form-control" placeholder="Alamat Rujukan" required></textarea>
                        <div class="invalid-feedback">
                            Alamat dibutuhkan
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="text" name="hasilPemeriksaan" class="form-control" placeholder="Masukkan Hasil Pemeriksaan" required>
                        <div class="invalid-feedback">
