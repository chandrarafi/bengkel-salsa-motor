...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Edit Data <?= esc($riwayat['riwayatID']) ?></h5>
        </div>
        <div class="card-body">
            <form action="<?= site_url('update-riwayats') ?>" method="post" class="row gy-3 needs-validation" novalidate>
                ...
                <input type="hidden" name="ibuID" value="<?= esc($riwayat['ibuID']) ?>">
                <div class="col-md-4">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="number" name="kehamilan" class="form-control" placeholder="Masukan Data" value="<?= esc($riwayat['kehamilan']) ?>" required>
                ...
                <div class="col-md-4">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="number" name="gravida" class="form-control" placeholder="Masukan Data" value="<?= esc($riwayat['gravida']) ?>" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="number" name="partus" class="form-control" placeholder="Masukan Data" value="<?= esc($riwayat['partus']) ?>" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="number" name="abortus" class="form-control" placeholder="Masukan Data" value="<?= esc($riwayat['abortus']) ?>" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="number" name="lahirMati" class="form-control" placeholder="Masukan Data" value="<?= esc($riwayat['lahirMati']) ?>" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="date" name="tanggalHPL" class="form-control" placeholder="Masukan Data" value="<?= esc($riwayat['tanggalHPL']) ?>" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="date" name="tanggalHPHT" class="form-control" placeholder="Masukan Data" value="<?= esc($riwayat['tanggalHPHT']) ?>" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="date" name="taksiranPersalinan" class="form-control" placeholder="Masukan Data" value="<?= esc($riwayat['taksiranPersalinan']) ?>" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="date" name="persalinanSebelumnya" class="form-control" placeholder="Masukan Data" value="<?= esc($riwayat['persalinanSebelumnya']) ?>" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="number" name="bbSebelum" class="form-control" placeholder="Masukan Data" value="<?= esc($riwayat['bbSebelum']) ?>" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-10">
                    ...
                    <div class="icon-field has-validation">
                        ...
                        <input type="number" name="tb" class="form-control" placeholder="Masukan Data" value="<?= esc($riwayat['tb']) ?>" required>
                        <div class="invalid-feedback">
