(function ($) {
  ...
  $(function () {
    ...
    $("ul#sidebar-menu a").each(function () {
      ...
      if (nk === linkHref || (linkHref.indexOf('/admin/users') !== -1 && nk.indexOf('/admin/users') !== -1) || (linkHref.indexOf('/admin/kategori') !== -1 && nk.indexOf('/admin/kategori') !== -1) || (linkHref.indexOf('/admin/satuan') !== -1 && nk.indexOf('/admin/satuan') !== -1) || (linkHref.indexOf('/satuan') !== -1 && nk.indexOf('/satuan') !== -1)) {
        $(this).addClass("active-page");
        $(this).parent().addClass("active-page active");
      }
    });
  });
